 ...
 * @LastEditTime: 2019-12-09 11:28:19
...
<template>
  <div class="page-wrap">
    ...
    <a
      class="coverages"
      target="_Blank"
      :href="'https://dev-wesurance814.com/wesupromo/webview/coverageDetails?product_id='+product_id+'&language='+language"
    >
      <span class="covers">
...
export default {
  ...
  methods: {
    ...
    proceed() {
      ...
      console.log(!this.price && this.errorInfo != "");
