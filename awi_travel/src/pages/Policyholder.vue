 ...
 * @LastEditTime: 2019-12-06 17:30:51
  ...
  methods: {
    ...
    getProtectorInfo() {
      ...
      if (this.protectorInfo) {
        console.log("当protectorInfo有值时,把值赋值给form");
        ...
        //如果有本人且大于十八岁
        console.log(this.userInfo[0].datebirth);
        console.log(this.getYears(this.userInfo[0].datebirth));
