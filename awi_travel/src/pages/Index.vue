 ...
 * @LastEditTime: 2019-12-09 11:27:18
...
<template>
  <div class="page-wrap">
    ...
    <div class="discount">{{data.discount_price_desc}}</div>
    ...
    <div>
      ...
      <div class="key-content">
        <div class="features-wrap">
          <p :class="{'features': flag}" v-html="data.remarks"></p>
    ...
    <a
      class="coverages"
      target="_Blank"
      :href="'https://dev-wesurance814.com/wesupromo/webview/coverageDetails?product_id='+productId+'&language='+Language"
    >
      <span class="covers">
    ...
    <!-- add-on -->
    <!-- <div class="addOn" @input="changeStatus">
      <p>add-on</p>
      <div class="img_btn">
        <img src="../assets/images/B35C491C-79D3-4E67-8D5D-C94942DDBC5D.png" alt />
        <span>HK $ 8 per day Self-Driving Coverage Add-on</span>
  ...
  async mounted() {
    ...
    try {
      ...
      if (res.status == 100) {
        ...
        this.setPlan({
          period_type: res.data.period_type,
          period_value: res.data.period_value,
          price_desc: res.data.price_desc,
        ...
        this.data.remarks = this.ReplaceUrl(res.data.remarks);
        this.data.customer_service = this.ReplaceUrl(res.data.customer_service);
      }
    } catch (error) {
      if (error.msg) {
        //请求错误
  ...
  .addOn {
    ...
    .img_btn {
      ...
      @{deep} .cube-switch {
        display: inline-block;
        height: 80px;
        .cube-switch-input:checked + .cube-switch-ui:after {
          transform: translateX(30px);
        }
        i {
          height: 48px;
          width: 78px;
          background-color: rgb(32, 192, 80);
          border: 0;
          margin-top: 10px;
          border: 2px solid rgb(174, 175, 173);
          &::after {
            width: 48px;
            height: 48px;
          }
  ...
  .popover {
    ...
    .discount_img_info {
      background: radial-gradient(
          ...
          top left,
        radial-gradient(circle at right bottom, transparent 26px, #fff 10px)
          right top;
