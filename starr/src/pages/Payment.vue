 ...
 * @LastEditTime: 2019-12-11 18:20:18
  ...
  <div class="page-wrap">
    ...
    <div class="subtotalPrice">
      <span>
        ...
        <p>
          {{$t('checkout_no_levy_message')}}
          <span class="collection">
            <img
              @click="hint"
              src="../assets/images/icon_tu_info.png"
              style="display:inline-block;width:13px;height:13px;vertical-align:top;"
            />
          </span>
        </p>
        <p>{{$t('coupon_title')}}</p>
      ...
      if (this.checked != true) {
        ...
        try {
          const res = await this.$http.post(
            "/wesupromo/web/checkout/purchasebystarr",
            paymentParams
          );
          if ((res.status = 100)) {
        ...
        // this.$http
        //   .post("/wesupromo/web/checkout/purchasebystarr", paymentParams)
        //   .then(res => {
        //     console.log(res);
        //     if ((res.status = 100)) {
        //       console.log(res);
