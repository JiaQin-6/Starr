 ...
 * @LastEditTime: 2019-12-09 11:25:20
  ...
  <div class="page-wrap">
    ...
    <div class="buttons">
      <button
        ...
        :class="{isActive:plan.period_value == item.period_value}"
    ...
    <div class="button-bar">
      <button class="quato" @click="quato">{{$t('products_proceed')}}</button>
    </div>
    <!-- 提示背景 -->
    ...
    <div v-show="isShow" class="popover">
      <div class="discount_img_info">
        ...
        <div class="product_logo_info">
          <img class="product_logo" :src="data.progress_logo" alt />
        </div>
  ...
  async mounted() {
    ...
    try {
      ...
      if (res.status == 100) {
        ...
        this.setcategoryName(res.data.category_name);
